...
> 📌 origin.xlsx 41개 외에 AI가 추가 도출한 **제안 명제 17개(P42~P58)**: [proposed/README.md](proposed/README.md) — P48 과목균형↔메디컬(d−0.86), P53 입시 등급 사다리(성적 ρ+0.58/행동 ≤0.06), P54 과목별(수·국 d≈1.2) 등.
...
- **📈 시각화**: 분석 가능한 **55/57 문서에 차트 완비**(불가 25·31 제외) + 메타 차트 4종. 각 차트는 문서 검증 수치를 그대로 시각화.
- **➕ 제안 명제 17개(P42~P58)**: origin 41개 외 AI 도출 → [proposed/](proposed/README.md). 그중 P53~P58은 입시 등급 사다리·과목별·학교유형·N수 등 미탐색 필드 발굴.

## 📊 핵심 시각 요약 — 네 장의 그림으로 보는 결론

58개 명제(origin 41 + 제안 17)를 관통하는 **핵심 발견 셋(①~③)** 과 **방법론 경고 하나(④)**. 개별 분석의 상세는 각 문서를 참고.
