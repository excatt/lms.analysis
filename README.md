...
> 📌 origin.xlsx 41개 외에 AI가 추가 도출한 **제안 명제 22개(P42~P63)**: [proposed/README.md](proposed/README.md) — P48 과목균형↔메디컬(d−0.86), P53 입시 등급 사다리, P54 과목별(수·국 d≈1.2), **🎯 P59~P63 마케팅 가치제안**("잇올 다니면 도움" — 고몰입 9.1h·전국 백분위 80.6·중경외시+ 39.4%·7개월+ 성적 +7p) 등.
...
- **📈 시각화**: 분석 가능한 **60/62 문서에 차트 완비**(불가 25·31 제외) + 메타 차트 4종. 각 차트는 문서 검증 수치를 그대로 시각화.
- **➕ 제안 명제 22개(P42~P63)**: origin 41개 외 AI 도출 → [proposed/](proposed/README.md). P53~P58 미탐색 필드 발굴, **🎯 P59~P63 마케팅 가치제안**(정직한 한계 포함).

## 📊 핵심 시각 요약 — 네 장의 그림으로 보는 결론

63개 명제(origin 41 + 제안 22)를 관통하는 **핵심 발견 셋(①~③)** 과 **방법론 경고 하나(④)**. 마케팅 가치제안은 [proposed 🎯 P59~P63](proposed/README.md). 개별 분석의 상세는 각 문서를 참고.
