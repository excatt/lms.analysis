...
- **이진컷 ≠ 연속**: 여기 d=+0.05는 메디컬(상위 ~5% 극단)만 잘라 범위 제한된 값이다. 성적을 *연속 백분위*로 펴면 "성적 상위권일수록 몰입·꾸준함이 약하게 더 높다"가 살아난다(재원생 ρ=+0.12, p<1e-16) — 단 작고 인과 아님. 방향을 뒤집은 서술적 검증은 [P52](../proposed/P52-score-level-vs-focus.md).
