...
origin.xlsx의 41개 명제와 **별도로**, 분석 과정에서 쌓인 데이터·발견을 바탕으로 AI가 추가 도출한 명제 22개. 기존 데이터를 재활용해 검증.

> **P42~P52**: 순위·성적 동역학 재해석. **P53~P58**: 미탐색 필드(입시 등급 사다리·과목별·학교유형·N수 등) 발굴. **P59~P63(마케팅)**: "잇올 다니면 도움이 된다" 가치제안 — 정직한 한계 포함.
...
| [P59](P59-high-focus-environment.md) | 🎯 고몰입 환경(전원) | ✅ 마케팅 가능 | 평균 9.1h·66% 8h+ |
| [P60](P60-national-percentile-position.md) | 🎯 전국 상위권 포진 | ✅ 마케팅(선발주의) | 평가원 백분위 80.6 |
| [P61](P61-score-growth-during-enrollment.md) | 🎯 재원 중 성적 향상 | ◐ 조건부(RTM주의) | 62% 향상·하위 +11.5p |
| [P62](P62-admission-track-record.md) | 🎯 입시 배출 실적 | ✅ 마케팅(선발주의) | 중경외시+ 39.4% |
| [P63](P63-tenure-threshold-vs-growth.md) | 🎯 재원 7개월+ ↔ 성적·입시 | ◐ 성적향상만 / ✗ 입시 | 7m+ +7.2p / 입시 7.3%=7.3% |

**집계**: ✅ 지지/발견 **9**(P43·P48·P51·P53·P54·P55·P56·P59·P62) · ◐ 약함/조건부 **7**(P42·P45·P50·P52·P57·P61·P63) · ✗ 무의미 **5**(P44·P46·P47·P49·P58) · 🎯 마케팅 5(P59~P63)
...
## 🎯 마케팅 가치제안 (P59~P62) — "잇올 다니면 도움이 된다"

지금까지 분석은 전부 **잇올 *내부* 비교**(어떤 잇올생이 더 잘하나)라 마케팅엔 부적합했다("행동 무변별·선발효과"). 마케팅용은 **입학 전→후 성장** 또는 **외부 대비 우위** 프레임이 필요하다. 데이터로 방어 가능한 4개:

| 명제 | 핵심 수치 | 추천 카피 | 🔴 정직한 한계 |
|------|------|------|------|
| **P59 고몰입 환경** | 평균 9.1h, 66% 8h+ | "하루 9시간 순공이 기본인 환경" | 현재생 기준(생존자), 순수 서술(인과 아님) — **가장 안전** |
| **P60 전국 위치** | 평가원 백분위 80.6, 97%>50 | "97%가 전국 평균 초과" | **선발효과**(우수 학생 유입) — '현재 위치'로만 |
| **P61 성적 향상** | 62% 향상, 하위 +11.5p | "재원 중 62% 성적 향상" | **평균회귀·대조군 부재**, 졸업생 −2.3p — '재원 중 하위권'으로 한정 |
| **P62 배출 실적** | 중경외시+ 39.4%, 메디컬 523 | "졸업생 5명 중 2명 중경외시+" | **선발효과** — '배출'(사실)로, '합격시킴'(인과) 금지 |
| **P63 재원 7개월+** | 성적 +7.2p / 입시 7.3%=7.3% | "7개월+ 다닌 학생 성적 +7p" | ✗ **입시엔 절대 금지** · 측정기간 교란·RTM |

> **권고**: 가장 깨끗한 건 **P59(고몰입 환경)** — 인과 가정 없이 순수 사실이다. P60·P62는 강력하지만 *선발효과*(우수 학생이 모인 결과)를 인지하고 "현재 위치/배출 실적"으로만 써야 한다. P61(성적 향상)은 *평균 회귀*가 섞여 "잇올이 올렸다"는 인과로 확대하면 위험하다. ⚠️ 검증해보니 **몰입 성장(재원 중 −1.38h 감소)·졸업생 성적 성장(−2.3p)은 마케팅 불가**(쓰지 말 것).
